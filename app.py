...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "IND":
        return "uid=4752935154&password=RAJA_BYSTARGMR_MbaxNCEU"
    elif r == "ME":
        return "uid=4752857113&password=RAJA_BYSTARGMR_ssuub5sA"
    elif r in {"BR", "US", "SAC", "NA"}:
        return "uid=4752855563&password=RAJA_BYSTARGMR_EkCd08qT"
    else:
        return "uid=4752894466&password=RAJA_BYSTARGMR_kkQsUT5g"
